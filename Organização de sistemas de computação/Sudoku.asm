...
MSG12       DB 186,29 DUP(32),'PARABENS VOCE GANHOU',29 DUP(32),186,'$'
...
.CODE
    ...
    TELAFINAL PROC ; PROC PARA CONCLUSAO DO JOGO, VAI IMPRIMIR UMA MENSAGEM QUE VC GANHOU E O SUDOKU COMPLETO
        PRINT TELA1
        PRINT MSG12
        PRINT TELA5
        CALL SAIDA
    ...
    TESTE PROC; DIFICULDADE TESTE, FALTANDO APENAS UMA CASA SER PREENCHIDA PARA CONCLUIR O SUDOKU
        XOR BX,BX
            XOR SI,SI
                MOV MATRIZ [BX][SI],2
                INC SI
